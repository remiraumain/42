...
/*   Updated: 2024/10/16 18:46:37 by rraumain         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#in
	/* clude "../../../Utils/testy/testy.h"                                       \
 ...
 {                                                                                \
		...
		char		*result_custom;                                                        \
                                                                                  \
		c_std = 'W';                                                                 \
		result_std = strchr(haystack_std,
				c_std);                                    \
		result_custom = ft_strchr(haystack_std,
				c_std);                              \
		assert_eq((result_std != NULL),
			(result_custom != NULL));                    \
		if (result_std
			&& result_custom)                                             \
		{                                                                            \
			assert_eq(strcmp(result_std, result_custom),
				0);                         \
		}                                                                            \
 }                                                                                \
                                                                                  \
 ...
 {                                                                                \
		...
		result_custom = ft_strchr(haystack_std,
				c_std);                              \
		assert_eq((result_std == haystack_std),
			(result_custom == haystack_std));    \
 }                                                                                \
                                                                                  \
 ...
 {                                                                                \
		...
		char	*result_custom;                                                         \
                                                                                  \
		c_std = 'W';                                                                 \
		result_std = strchr(haystack_with_null,
				c_std);                              \
		result_custom = ft_strchr(haystack_with_null,
				c_std);                        \
		assert_eq((result_std == NULL),
			(result_custom == NULL));                    \
 }                                                                                \
 ...
 {                                                                                \
		run_test(test_ft_strchr_basic,
			"ft_strchr_basic");                           \
		run_test(test_ft_strchr_at_start,
			"ft_strchr_at_start");                     \
		run_test(test_ft_strchr_at_end,
			"ft_strchr_at_end");                         \
		run_test(test_ft_strchr_not_found,
			"ft_strchr_not_found");                   \
		run_test(test_ft_strchr_null_char,
			"ft_strchr_null_char");                   \
		run_test(test_ft_strchr_empty_haystack,
			"ft_strchr_empty_haystack");         \
		run_test(test_ft_strchr_repeated_characters,
			                                \
			"ft_strchr_repeated_characters");                                        \
		run_test(test_ft_strchr_special_characters,
			"ft_strchr_special_characters"); \
